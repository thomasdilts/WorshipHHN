...
<div class="user-index">
    ...
    <h1>
        ...
        <span class="pull-right" style="margin-bottom:5px">
            ...
            <a href='<?=URL::toRoute('doc/doc')?>?page=activity-type-index&returnName=<?=$this->title?>&returnUrl=<?=URL::toRoute('activity-type/index')?>' class='btn btn-primary'><span class="glyphicon glyphicon-question-sign"></span></a>			
        </span>         
    </h1>
