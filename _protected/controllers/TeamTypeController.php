...
class TeamTypeController extends AppController
{
    ...
    public function actionCreate()
    {
		...
		Log::write('TeamType', LogWhat::CREATE, null, (string)$model);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->save()) {
			Log::write('TeamType', LogWhat::UPDATE, (string)$modelOld, (string)$model);
    ...
    public function actionDelete($id)
    {
		...
		Log::write('TeamType', LogWhat::DELETE, (string)$model, null);
